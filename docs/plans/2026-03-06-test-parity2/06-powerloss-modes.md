...
cargo test -p lp-littlefs --features slow_tests -- test_powerloss

# New modes work with a simple smoke test
cargo test -p lp-littlefs test_powerloss_runner_smoke_log
cargo test -p lp-littlefs test_powerloss_runner_smoke_exhaustive
```
