...
```bash
cargo test -p lp-littlefs test_orphans_normal
cargo test -p lp-littlefs test_orphans_one_orphan
cargo test -p lp-littlefs test_orphans_mkconsistent_one_orphan
```
