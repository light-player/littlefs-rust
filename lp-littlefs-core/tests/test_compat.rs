...
use lp_littlefs_core::lfs_type::lfs_type::LFS_TYPE_INLINESTRUCT;
...
fn test_compat_minor_bump() {
    use lp_littlefs_core::lfs_type::lfs_open_flags::{
        LFS_O_CREAT, LFS_O_EXCL, LFS_O_RDONLY, LFS_O_TRUNC, LFS_O_WRONLY,
    };
    use lp_littlefs_core::{lfs_file_close, lfs_file_open, lfs_file_read, lfs_file_write};
